...
struct ErrorTest
{
    ...
    ErrorTest(int intVal, std::string& stringVal) : intVal_{intVal}, stringVal_{stringVal} {}

    void ThrowAsException() const { throw std::runtime_error("ErrorTest exception"); }
...
bool operator==(ErrorTest const& lhs, ErrorTest const& rhs) { return lhs.getIntVal() == rhs.getIntVal(); }

struct ValueTest
{
    ValueTest(int intVal) : intVal_{intVal}, stringVal_{"Init"} {}
    ValueTest(std::string& stringVal) : intVal_{0}, stringVal_{stringVal} {}
    ValueTest(int intVal, std::string& stringVal) : intVal_{intVal}, stringVal_{stringVal} {}

    int operator+(int valueToAdd) { intVal_ += valueToAdd; return intVal_;}
...
TEST_CASE("Constructs and destructs a Result based on value", "[SWS_CORE], [SWS_CORE_00721], [SWS_CORE_00722], [SWS_CORE_00731]")
{
    ValueTest value(10);
...
TEST_CASE("Constructs and destructs a Result based on error", "[SWS_CORE], [SWS_CORE_00723], [SWS_CORE_00724], [SWS_CORE_00731]")
{
    ErrorTest error(10);
...
TEST_CASE("Copy and Move constructs a Result based on other instance", "[SWS_CORE], [SWS_CORE_00725], [SWS_CORE_00726]")
{
    ValueTest value(10);
    ...
    ara::core::Result<ValueTest> movedResultBasedOnValue(std::move(resultBasedOnValue));
    CHECK(movedResultBasedOnValue.HasValue());
    
    ErrorTest error(10);
    ara::core::Result<ValueTest, ErrorTest> resultBasedOnError(error);
    
    ara::core::Result<ValueTest, ErrorTest> copiedResultBasedOnError(resultBasedOnError);
    CHECK(!copiedResultBasedOnError.HasValue());
    
    ara::core::Result<ValueTest, ErrorTest> movedResultBasedOnError(std::move(resultBasedOnError));
    CHECK(!movedResultBasedOnError.HasValue());
}

TEST_CASE("Constuct a Result by FromValue method", "[SWS_CORE], [SWS_CORE_00731], [SWS_CORE_00732], [SWS_CORE_00733]")
{
    ...
    auto resultFromArguments = ara::core::Result<ValueTest>::FromValue(10, testString);
...
TEST_CASE("Constuct a Result by FromError method", "[SWS_CORE], [SWS_CORE_00734], [SWS_CORE_00735], [SWS_CORE_00736]")
{
    const ErrorTest error(10);
    auto resultLValue = ara::core::Result<ValueTest, ErrorTest>::FromError(error);
    auto resultRValue = ara::core::Result<ValueTest, ErrorTest>::FromError(ErrorTest(15));
    std::string testString = "Test string";
    auto resultFromArguments = ara::core::Result<ValueTest, ErrorTest>::FromError(10, testString);
...
TEST_CASE("Copy-assign", "[SWS_CORE], [SWS_CORE_00741]")
{
    ...
    auto resultWithValue1 = ara::core::Result<ValueTest, ErrorTest>::FromValue(ValueTest(10));
    auto resultWithValue2 = ara::core::Result<ValueTest, ErrorTest>::FromValue(ValueTest(20));
    ...
    auto resultWithError1 = ara::core::Result<ValueTest, ErrorTest>::FromError(ErrorTest(30));
    auto resultWithError2 = ara::core::Result<ValueTest, ErrorTest>::FromError(ErrorTest(40));
...
TEST_CASE("Move-assign", "[SWS_CORE], [SWS_CORE_00742]")
{
    ...
    resultWithValue1 = ara::core::Result<ValueTest, ErrorTest>::FromValue(ValueTest(20));
    ...
    resultWithError1 = ara::core::Result<ValueTest, ErrorTest>::FromError(ErrorTest(40));
    
    CHECK(resultWithError1.Error().getIntVal() == 40);

    // Result1 has a value, Result2 doesn't have a value
    resultWithValue1 = ara::core::Result<ValueTest, ErrorTest>::FromError(ErrorTest(50));
    CHECK(!resultWithValue1.HasValue());
    CHECK(resultWithValue1.Error().getIntVal() == 50);

    // Result1 doesn't have a value, Result2 has a value
    resultWithError1 = ara::core::Result<ValueTest, ErrorTest>::FromValue(ValueTest(60));
    CHECK(resultWithError1.HasValue());
...
TEST_CASE("EmplaceValue method", "[SWS_CORE], [SWS_CORE_00743]")
{
    ...
    auto resultWithError1 = ara::core::Result<ValueTest, ErrorTest>::FromError(ErrorTest(10));
    CHECK(!resultWithError1.HasValue());
...
TEST_CASE("Swap method", "[SWS_CORE], [SWS_CORE_00745]")
{
    ...
    auto resultWithValue1 = ara::core::Result<ValueTest, ErrorTest>::FromValue(ValueTest(value1, valueMessage1));
    auto resultWithValue2 = ara::core::Result<ValueTest, ErrorTest>::FromValue(ValueTest(value2, valueMessage2));
    CHECK(resultWithValue1.HasValue());
    CHECK(resultWithValue2.HasValue());
    ...
    auto resultWithError1 = ara::core::Result<ValueTest, ErrorTest>::FromError(ErrorTest(error1, errorMessage1));
    auto resultWithError2 = ara::core::Result<ValueTest, ErrorTest>::FromError(ErrorTest(error2, errorMessage2));
    CHECK(!resultWithError1.HasValue());
    CHECK(!resultWithError2.HasValue());
...
TEST_CASE("Value getters and checkers", "[SWS_CORE], [SWS_CORE_00751], [SWS_CORE_00752], [SWS_CORE_00753], [SWS_CORE_00759], [SWS_CORE_00754], [SWS_CORE_00755], [SWS_CORE_00756]")
{
    auto resultWithValue1 = ara::core::Result<ValueTest, ErrorTest>::FromValue(ValueTest(10));
    CHECK(resultWithValue1.HasValue());
    ...
    ValueTest value2(*(ara::core::Result<ValueTest, ErrorTest>::FromValue(ValueTest(10))));
    CHECK(value2.getIntVal() == 10);

    CHECK(resultWithValue1->getIntVal() == 10);

    CHECK(resultWithValue1.Value().getIntVal() == 10);
    auto value3(ara::core::Result<ValueTest, ErrorTest>::FromValue(ValueTest(10)).Value());
...
{
    auto resultWithError1 = ara::core::Result<ValueTest, ErrorTest>::FromError(ErrorTest(10));
    ErrorTest error(ara::core::Result<ValueTest, ErrorTest>::FromError(ErrorTest(10)).Error());
...
{
    auto resultWithValue = ara::core::Result<ValueTest, ErrorTest>::FromValue(ValueTest(10));
    auto resultWithError = ara::core::Result<ValueTest, ErrorTest>::FromError(ErrorTest(20));
    ...
    ValueTest value3(ara::core::Result<ValueTest, ErrorTest>::FromValue(ValueTest(10)).ValueOr(88));
    ValueTest value4(ara::core::Result<ValueTest, ErrorTest>::FromError(ErrorTest(20)).ValueOr(88));
...
TEST_CASE("ValueOrThrow method", "[SWS_CORE], [SWS_CORE_00766], [SWS_CORE_00769]")
{
    auto resultWithValue = ara::core::Result<ValueTest, ErrorTest>::FromValue(ValueTest(10));
    auto resultWithError = ara::core::Result<ValueTest, ErrorTest>::FromError(ErrorTest(20));
    ...
    ValueTest value(ara::core::Result<ValueTest, ErrorTest>::FromValue(ValueTest(10)).ValueOrThrow());
    ...
    try {
        auto value1(ara::core::Result<ValueTest, ErrorTest>::FromError(ErrorTest(20)).ValueOrThrow());
    }
    catch(std::runtime_error&)
    {
        exceptionThrown = true;
...
{
    auto resultWithValue = ara::core::Result<ValueTest, ErrorTest>::FromValue(ValueTest(10));
    auto value1 = resultWithValue.Bind([](ValueTest val)->ValueTest{ return val + 50; });
...
TEST_CASE("Specialization for value_type=void: Constructs and destructs a Result with void value", "[SWS_CORE], [SWS_CORE_00801], [SWS_CORE_00825]")
{
...
TEST_CASE("Specialization for value_type=void: Constructs and destructs a Result based on error", "[SWS_CORE], [SWS_CORE_00823], [SWS_CORE_00825]")
{
    ErrorTest error(10);
...
TEST_CASE("Specialization for value_type=void: Copy and Move constructs a Result based on other instance", "[SWS_CORE], [SWS_CORE_00785], [SWS_CORE_00826]")
{
    ...
    ara::core::Result<void> movedResultBasedOnValue(std::move(resultBasedOnValue));
    CHECK(movedResultBasedOnValue.HasValue());
    
    ErrorTest error(10);
    ara::core::Result<void, ErrorTest> resultBasedOnError(error);
    
    ara::core::Result<void, ErrorTest> copiedResultBasedOnError(resultBasedOnError);
    CHECK(!copiedResultBasedOnError.HasValue());
    
    ara::core::Result<void, ErrorTest> movedResultBasedOnError(std::move(resultBasedOnError));
    CHECK(!movedResultBasedOnError.HasValue());
}

TEST_CASE("Specialization for value_type=void: Constuct a Result by FromValue method", "[SWS_CORE], [SWS_CORE_00831]")
{
    auto value = ara::core::Result<void>::FromValue();
    CHECK(value.HasValue());
}

TEST_CASE("Specialization for value_type=void: Constuct a Result by FromError method", "[SWS_CORE], [SWS_CORE_00834], [SWS_CORE_00835], [SWS_CORE_00836]")
{
    const ErrorTest error(10);
    auto resultLValue = ara::core::Result<void, ErrorTest>::FromError(error);
    auto resultRValue = ara::core::Result<void, ErrorTest>::FromError(ErrorTest(15));
    std::string testString = "Test string";
    auto resultFromArguments = ara::core::Result<void, ErrorTest>::FromError(10, testString);
...
TEST_CASE("Specialization for value_type=void: Copy-assign", "[SWS_CORE], [SWS_CORE_00841]")
{
    ...
    // Result1 doesn't have a value, Result2 doesn't have a value
    auto resultWithError1 = ara::core::Result<void, ErrorTest>::FromError(ErrorTest(30));
    auto resultWithError2 = ara::core::Result<void, ErrorTest>::FromError(ErrorTest(40));
...
TEST_CASE("Specialization for value_type=void: Move-assign", "[SWS_CORE], [SWS_CORE_00842]")
{
    auto resultWithValue1 = ara::core::Result<void, ErrorTest>::FromValue();
    ...
    // Result1 doesn't have a value, Result2 doesn't have a value
    resultWithError1 = ara::core::Result<void, ErrorTest>::FromError(ErrorTest(40));
    CHECK(resultWithError1.Error().getIntVal() == 40);

    // Result1 has a value, Result2 doesn't have a value
    resultWithValue1 = ara::core::Result<void, ErrorTest>::FromError(ErrorTest(50));
    CHECK(!resultWithValue1.HasValue());
    CHECK(resultWithValue1.Error().getIntVal() == 50);
...
TEST_CASE("Specialization for value_type=void: EmplaceValue method", "[SWS_CORE], [SWS_CORE_00843]")
{
    // Result already has a value
    auto resultWithValue1 = ara::core::Result<void, ErrorTest>::FromValue();
    CHECK(resultWithValue1.HasValue());
    ...
    // Result already has an error
    auto resultWithError1 = ara::core::Result<void, ErrorTest>::FromError(ErrorTest(10));
    CHECK(!resultWithError1.HasValue());
...
TEST_CASE("Specialization for value_type=void: EmplaceError method", "[SWS_CORE], [SWS_CORE_00844]")
{
    // Result already has a value
    auto resultWithValue1 = ara::core::Result<void, ErrorTest>::FromValue();
...
TEST_CASE("Specialization for value_type=void: Swap method", "[SWS_CORE], [SWS_CORE_00845]")
{
    int error1 = 21;
    int error2 = 22;
    std::string valueMessage1 = "Value Message1";
    ...
    auto resultWithError1 = ara::core::Result<void, ErrorTest>::FromError(ErrorTest(error1, errorMessage1));
    auto resultWithError2 = ara::core::Result<void, ErrorTest>::FromError(ErrorTest(error2, errorMessage2));
    CHECK(!resultWithError1.HasValue());
    CHECK(!resultWithError2.HasValue());
    CHECK(resultWithError1.Error().getIntVal() == error1);
    CHECK(resultWithError2.Error().getIntVal() == error2);
...
TEST_CASE("Specialization for value_type=void: Value getters and checkers", "[SWS_CORE], [SWS_CORE_00851], [SWS_CORE_00852], [SWS_CORE_00853], [SWS_CORE_00855]")
{
    auto resultWithValue1 = ara::core::Result<void, ErrorTest>::FromValue();
    CHECK(resultWithValue1.HasValue());
...
TEST_CASE("Specialization for value_type=void: Error getters", "[SWS_CORE], [SWS_CORE_00857], [SWS_CORE_00858]")
{
    auto resultWithError1 = ara::core::Result<void, ErrorTest>::FromError(ErrorTest(10));
    ErrorTest error(ara::core::Result<void, ErrorTest>::FromError(ErrorTest(10)).Error());

    CHECK(resultWithError1.Error().getIntVal() == error.getIntVal());
}

TEST_CASE("Specialization for value_type=void: ValueOr method", "[SWS_CORE], [SWS_CORE_00861]")
{
...
TEST_CASE("Specialization for value_type=void: ErrorOr method", "[SWS_CORE], [SWS_CORE_00863]")
{
    auto resultWithValue = ara::core::Result<void, ErrorTest>::FromValue();
    auto resultWithError = ara::core::Result<void, ErrorTest>::FromError(ErrorTest(20));
...
TEST_CASE("Specialization for value_type=void: CheckError method", "[SWS_CORE], [SWS_CORE_00865]")
{
    auto resultWithValue = ara::core::Result<void, ErrorTest>::FromValue();
    CHECK(!resultWithValue.CheckError(20));
...
#if __cpp_exceptions == 199711
TEST_CASE("Specialization for value_type=void: ValueOrThrow method", "[SWS_CORE], [SWS_CORE_00866]")
{
    auto resultWithValue = ara::core::Result<void, ErrorTest>::FromValue();
    auto resultWithError = ara::core::Result<void, ErrorTest>::FromError(ErrorTest(20));
...
TEST_CASE("Specialization for value_type=void: Resolve method", "[SWS_CORE], [SWS_CORE_00867]")
{
    auto resultWithValue = ara::core::Result<void, ErrorTest>::FromValue();
    // just for coverage
...
TEST_CASE("Compare two Result instances for equality", "[SWS_CORE], [SWS_CORE_00780]")
{
...
TEST_CASE("Compare two Result instances for inequality", "[SWS_CORE], [SWS_CORE_00781]")
{
    CHECK(!(ara::core::Result<int, ErrorTest>::FromValue(10)
        != ara::core::Result<int, ErrorTest>::FromValue(10)));
...
TEST_CASE("Compare a Result instance for equality to a value", "[SWS_CORE], [SWS_CORE_00782], [SWS_CORE_00783], [SWS_CORE_00784], [SWS_CORE_00785]")
{
...
TEST_CASE("Compare a Result instance for equality to an error", "[SWS_CORE], [SWS_CORE_00786], [SWS_CORE_00787], [SWS_CORE_00788], [SWS_CORE_00789]")
{
...
TEST_CASE("Swap the contents of the two given arguments", "[SWS_CORE], [SWS_CORE_00796]")
{
    int value1 = 11;
    int value2 = 12;
    int error1 = 21;
