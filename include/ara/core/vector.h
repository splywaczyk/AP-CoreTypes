...
public:
    ...
    /**
     * @brief Constructs a vector with @c count copies of @c value, using the specified allocator @c alloc.
     *
     * @param[in] count - size of the container.
     * @param[in] value - initial value of single element.
     * @param[in] alloc - allocator.
     */
    Vector(size_type count, const T& value, const Allocator& alloc = Allocator()) : _impl(count, value, alloc) {}
        
    /**
     * @brief Constructs a vector equal to the range @c [first,last), using the specified allocator @c alloc.
     *
    ...
    Vector(InputIterator first, InputIterator last, const Allocator& alloc = Allocator()) : _impl(first, last, alloc) {}
    ...
    /**
     * @brief Move constructor. Constructs the container with the contents of @c other using move semantics.
     *
     ...
     * Constructs the container with the copy of the contents of @c other using the specified allocator @c alloc.
     *
     * @param[in] other - content to be copied.
     * @param[in] alloc - allocator.
     */
    Vector(const Vector& other, const Allocator& alloc) : _impl(other._impl, alloc) {}
        
    /**
     * @brief Allocator-extended move constructor.
     * Constructs the container using move semantics with the contents of @c other using the specified allocator @c alloc.
     *
     * @param[in] other - content used to construct a container.
     * @param[in] alloc - allocator.
     */
    Vector(Vector&& other, const Allocator& alloc) : _impl(std::move(other._impl), alloc) {}
        
    /**
     * @brief Constructs the container with the contents of the initializer list @c init.
     *
     * @param[in] ilist - list of elements.
     * @param[in] alloc - allocator.
     */
    Vector(std::initializer_list<T> ilist, const Allocator& alloc = Allocator()) : _impl(ilist, alloc) {}
    
    /**
     * @brief Copy assignment operator. Replaces the contents with a copy of the contents of @c other.
     *
     * @param[in] other - content to be copied.
     */
    ...
    /**
     * @brief Move assignment operator. Replaces the contents with those of @c other using move semantics.
     *
     * @param[in] other - content used to construct a container.
     */
    ...
    /**
     * @brief Assignment operator. Replaces the contents with those identified by initializer list @c ilist.
     *
     * @param[in] ilist - list of elements.
     */
     ...
     */
    template <class InputIterator>
    void assign(InputIterator first, InputIterator last) { _impl.assign(first, last); }
    ...
    /**
     * @brief Replaces the contents with the elements from the initializer list @c ilist.
     *
     * @param[in] ilist - list of elements.
     */
     ...
     */
    allocator_type get_allocator() const noexcept { return _impl.get_allocator(); }
     ...
     *
     * @param[in] count - new size of the container.
     * @param[in] value - the value to initialize the new elements with in case when current size is less than @c count.
     */
    ...
    /**
     * @brief Increase the capacity of the vector to a value that's greater or equal to @c new_cap.
     *
    ...
    /**
     * @brief Returns a const reference to the element at specified location @c pos. No bounds checking is performed.
     *
     * @param[in] pos - position of the element to return.
     *
     * @return Reference to the requested element.
     ...
     */
    template <class... Args>
    void emplace_back(Args&&... args) { _impl.emplace_back(std::forward<Args>(args)...); }     
     ...
     */
    template <class... Args>
    iterator emplace(const_iterator pos, Args&&... args) { return _impl.emplace(pos, std::forward<Args>(args)...); }     
     ...
     */
    iterator insert(const_iterator pos, const T& value) { return _impl.insert(pos, value); }     
     ...
     * @return Iterator pointing to the.
     */
    iterator insert(const_iterator pos, T&& value) { return _impl.insert(pos, std::move(value)); }     
            
    /**
     * @brief Inserts @c count copies of the @c value into the container before @c pos
     *
     * @param[in] pos - iterator before which the content will be inserted.
     ...
     * @return Iterator pointing to the.
     */
    iterator insert(const_iterator pos, size_type count, const T& value) { return _impl.insert(pos, count, value); }     
            
    /**
     * @brief Inserts elements from range @c [first,last) into the container before @c pos.
     *
     * @param[in] pos - iterator before which the content will be inserted.
     ...
     */
    template <class InputIterator>
    iterator insert(const_iterator pos, InputIterator first, InputIterator last) { return _impl.insert(pos, first, last); }     
            
    /**
     * @brief Inserts elements from initializer list @c ilist into the container before @c pos.
     *
     * @param[in] pos - iterator before which the content will be inserted.
     ...
     * @return Iterator pointing to the.
     */
    iterator insert(const_iterator pos, std::initializer_list<T> ilist) { return _impl.insert(pos, ilist); }     
     ...
     * @return Iterator following the last removed element.
     */
    iterator erase(const_iterator first, const_iterator last) { return _impl.erase(first, last); }     
...
* they have the same number of elements and each element in @c lhs compares equal with the element in @c rhs at the same position.
* 
...
* @param[in] rhs - vector which content is compared.
* 
* @return @c true if the contents of the vectors are not equal, @c false otherwise.
* 
* @req {SWS_CORE_01391}
*/
template <class T, class Allocator>
...
* @param[in] rhs - vector which content is compared.
* 
* @return @c true if the contents of the @c lhs are lexicographically less than the contents of @c rhs, @c false otherwise.
* 
* @req {SWS_CORE_01392}
*/
template <class T, class Allocator>
...
* @param[in] rhs - vector which content is compared.
* 
* @return @c true if the contents of the @c lhs are lexicographically less than or equal the contents of @c rhs, @c false otherwise.
* 
* @req {SWS_CORE_01393}
*/
template <class T, class Allocator>
...
* @param[in] rhs - vector which content is compared.
* 
* @return @c true if the contents of the @c lhs are lexicographically greater than the contents of @c rhs, @c false otherwise.
* 
* @req {SWS_CORE_01394}
*/
template <class T, class Allocator>
...
* @param[in] rhs - vector which content is compared.
* 
* @return @c true if the contents of the @c lhs are lexicographically greater than or equal the contents of @c rhs, @c false otherwise.
* 
* @req {SWS_CORE_01395}
*/
template <class T, class Allocator>
